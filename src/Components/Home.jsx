        ...
        <div className="container text-center">
          <div className="row">
            <div className="col-md-6 text-start">
              ...
              <p>Elearn is a global training provider based across the UK that  <br />specialisesin accredited and bespoke training courses. We crush the...</p>
              <div className="pt-5">
                <div className="position-relative w-75">
                  <input className="border-0 rounded-pill w-100 py-3 ps-4 pe-5" type="text" name="search" placeholder="Eg: Thailand" />
